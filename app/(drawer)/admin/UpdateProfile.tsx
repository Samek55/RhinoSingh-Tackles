        ...
        <View style={styles.inputWrapper}>
            ...
            >
                ...
                <Text style={[styles.textInput, !value && { color: '#9CA3AF' }]} numberOfLines={1}>
                    {value ? `Selected (${selectedItems.length}) items` : placeholder}
                </Text>
            ...
            >
                <View style={styles.modalOverlay}>
                    {/* Transparent top space allowing background click to close */}
                    <TouchableOpacity
                    ...
                    {/* Menu panel taking exactly the remaining 80% height */}
...
export default function ModernUpdateProfile() {
    const {
        ...
        email,
        setEmail,
        positionAppliedFor: rawPositionAppliedFor,
                ...
                <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                    ...
                    <View style={styles.profileBadgeCard}>
                        ...
                        {status && (
                            <View style={[
                                styles.statusBadge,
                                { backgroundColor: status === 'Rejected' ? '#FEE2E2' : '#E8F5E9' }
                            ]}>
                                <Text style={[styles.statusText, { color: status === 'Rejected' ? '#EF4444' : '#2E7D32' }]}>
                                    Status: {status}
                                </Text>
                            </View>
                        )}
                    ...
                    <View style={styles.card}>
                        ...
                        <ProfileInputField label="Phone Number" value={phone} onChangeText={(v) => setPhone(v.replace(/[^0-9]/g, '').slice(0, 10))} icon="call-outline" placeholder="9852024365" keyboardType="number-pad" />
                    ...
                    <View style={styles.card}>
                        <ProfileDropdownArrayList
                            ...
                            value={rawPositionAppliedFor}
                            onChangeText={setPositionAppliedFor}
...
const styles = StyleSheet.create({
    ...
    avatarPlaceholder: { width: 80, height: 80, borderRadius: 40, backgroundColor: '#E8F5E9', justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: '#A5D6A7', marginBottom: 14 },
    ...
    statusBadge: { paddingVertical: 4, paddingHorizontal: 12, borderRadius: 8, marginTop: 4 },
    ...
    modalTopDismiss: {
        height: '20%' // Keeps the top 20% transparent and available to click-to-dismiss
    },
    modalContent: {
        backgroundColor: '#FFF',
        ...
        height: '80%' // Anchors the menu exactly into the bottom 80% area
    },
